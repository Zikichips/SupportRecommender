<div class="py-28">
  <div class="lg:max-w-4xl mx-auto">
    <h2 class="mt-2 text-xl font-semibold tracking-tight text-blue-500 sm:text-xl text-center">Incorrect character after import</h2>
      <h1 class="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-2xl text-center">Here are our recommendations</h1>
        ...
        <ul role="list" class="mt-8 space-y-8 text-gray-600">
            ...
            <li class="flex gap-x-3">
                ...
                <span><strong class="font-semibold text-gray-900">Update Charset:</strong> Make sure that the Character-set of the source site is the same as the destination site. For example, if the source site uses UTF8, then update the destination site to use the same. You just need to add the following line of code to your wp-config file: <code>define('DB_CHARSET', 'utf8');</code>. You may also have to convert the CHARSET from the database. You can read more about this <a href="https://codex.wordpress.org/Converting_Database_Character_Sets" target="_blank" class="text-blue-500">here</a> </span>
              </li>
